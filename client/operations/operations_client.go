...
type ClientService interface {
	...
	PostUser(params *PostUserParams, opts ...ClientOption) (*PostUserCreated, error)
...
*/
func (a *Client) PostUser(params *PostUserParams, opts ...ClientOption) (*PostUserCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
